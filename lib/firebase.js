...
if (!admin.apps.length) {
  ...
  console.log('private_key contains actual newlines:', serviceAccount.private_key?.includes('\n'));
  console.log('private_key contains \\n:', serviceAccount.private_key?.includes('\\n'));
  console.log('private_key line count:', serviceAccount.private_key?.split('\n').length);
  console.log('===========================');
